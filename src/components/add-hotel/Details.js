    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col md:flex-row gap-5 bg-gray-400 p-3">
                <label className={labelClass}>
                    Check In Time
                    <input type="datetime-local" {...register("checkIn", { required: "This field is require..." })} className={inputClass} />
                    {errors.checkIn && <span className="text-red-500">{errors.checkIn.message}</span>}
                </label>

                <label className={labelClass}>
                    Check Out Time
                    <input type="datetime-local" {...register("checkOut", { required: "This field is require..." })} className={inputClass} />
